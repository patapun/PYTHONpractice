class ECommercePlatform:
    ...
    def get_customer_id(self, customer_name):
        ...
        """
        customer_data = self.customer_profiles.get(customer_name)
        return customer_data.get('customer_id', -1) if customer_data else -1

    def get_customer_name_by_product(self, product_id):
        """
        Get the customer name associated with a product.
        ...
        """
        for customer_name, profile in self.customer_profiles.items():
