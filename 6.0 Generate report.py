class EventDatabase:
    ...
    def generate_report(self):
        """
        Generate a report for a specific event, including the number of attendees, customer names, event ratings, and feedback.
        """
        ...
        if event_id in self.events:
            ...
            for attendee in event_info['attendees']:
                print(f"- {attendee}")
            print("\nCustomer Feedback:")
            for idx, attendee in enumerate(event_info['attendees']):
                feedback_info = event_info['feedback']
